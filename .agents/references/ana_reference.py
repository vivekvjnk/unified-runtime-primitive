...
# """
# Read control-circuit.scud.
# Control circuit consists of these two modules: microcontroller-module and low-voltage-power-supply module. 
# Your task is to synthesize circuit code for the control-circuit. control-circuit should integrate micrcocontroller-module and low-voltage-power-supply module by connecting each other through the right set of ports.

# Following are a few high value references for the task:
# system-boundary.md, microcontroller-module/Workspace/resources/microcontroller-module-boundary.md, microcontroller-module/Workspace/microcontroller-module.scud, microcontroller-module/Workspace/microcontroller-module.tsx, low-voltage-power-supply/Workspace/resources/low-voltage-power-supply-boundary.md, low-voltage-power-supply/Workspace/low-voltage-power-supply.scud, low-voltage-power-supply/Workspace/low-voltage-power-supply.tsx

# Please prepare circuit code for the control-circuit, name it control-circuit.tsx and save it under current workspace
# """)

conversation.send_message(
"""
Read control-circuit.scud.
Control circuit consists of these 4 modules: bms-monitor-module and high-voltage-power-supply module, current-sensing module, communication-bridge module 
Your task is to synthesize circuit code for the power-circuit. power-circuit should integrate bms-monitor-module and high-voltage-power-supply module, current-sensing module and communication-bridge module by connecting them through the right set of ports.

Following are a few high value references for the task:
system-boundary.md, bms-monitor-module/Workspace/resources/bms-monitor-module-boundary.md, bms-monitor-module/Workspace/bms-monitor-module.scud, bms-monitor-module/Workspace/bms-monitor-module.tsx, high-voltage-power-supply/Workspace/resources/high-voltage-power-supply-boundary.md, high-voltage-power-supply/Workspace/high-voltage-power-supply.scud, high-voltage-power-supply/Workspace/high-voltage-power-supply.tsx. communication-bridge/Workspace/resources/communication-bridge-boundary.md, communication-bridge/Workspace/communication-bridge.scud, communication-bridge/Workspace/communication-bridge.tsx, current-sensing/Workspace/resources/current-sensing-boundary.md, current-sensing/Workspace/current-sensing.scud, current-sensing/Workspace/current-sensing.tsx

Please prepare circuit code for the power-circuit, name it power-circuit.tsx and save it under current workspace
""")
